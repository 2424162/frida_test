...
Java.perform(function () {
    ...
    console.log(Java.use("android.util.Log").getStackTraceString(Java.use("java.lang.Exception").$new()))
        ...
        var c = Java.use('com.yxcorp.gifshow.entity.QCurrentUser') ;

    c.getApiServiceToken.implementation = function () {

      //  showStacks();

        var re =this.getApiServiceToken() 
        var cc =this.getTokenClientSalt()
        console.log(cc);
