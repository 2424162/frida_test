...
return str;
        ...
        var c = Java.use('com.kuaishou.common.encryption.b$b') ;

    c.b.implementation = function (str1,str2,str3,str4) {

        //showStacks();


        var re1 = this.b(str1,str2,str3,str4);
        console.log(byteToString(str1));
        console.log(str1);
        console.log(str2);
        console.log(str3);
        console.log(str4);
